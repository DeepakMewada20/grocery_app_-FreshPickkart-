...
class CatalogOffersScreen extends StatefulWidget {
  const CatalogOffersScreen({super.key});

  @override
  State<CatalogOffersScreen> createState() => _CatalogOffersScreenState();
}

class _CatalogOffersScreenState extends State<CatalogOffersScreen> {
  ...
  Widget build(BuildContext context) {
    return DefaultTabController(
      ...
      child: Scaffold(
        appBar: AppBar(
          title: const Text('Catalog & Offers'),
          ...
          bottom: const TabBar(
            tabs: [
              ...
              Tab(text: 'Coupons', icon: Icon(Icons.discount_outlined)),
              Tab(text: 'Offers', icon: Icon(Icons.local_offer_outlined)),
            ],
          ),
        ),
        body: TabBarView(
