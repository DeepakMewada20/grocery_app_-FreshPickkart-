...
import '../data_flow/cart_pricing_result.dart' as _i2;
import '../data_flow/basket_suggestion_result.dart' as _i3;
import '../data_flow/coupon_display.dart' as _i4;
import '../data_flow/delivery_config.dart' as _i5;
import 'package:freshpickkat_client/src/protocol/protocol.dart' as _i6;

abstract class CartHydratedData implements _i1.SerializableModel {
  CartHydratedData._({
    this.cartPricing,
