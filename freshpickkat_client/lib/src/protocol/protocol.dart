...
import 'bogo_offer.dart' as _i9;
import 'cart_item.dart' as _i10;
import 'category.dart' as _i11;
import 'coupon.dart' as _i12;
import 'coupon_display.dart' as _i13;
import 'coupon_validation_result.dart' as _i14;
import 'order.dart' as _i15;
import 'order_item.dart' as _i16;
import 'order_page.dart' as _i17;
import 'payment_action_result.dart' as _i18;
import 'payment_order_result.dart' as _i19;
import 'payment_verify_result.dart' as _i20;
import 'product.dart' as _i21;
import 'product_page.dart' as _i22;
import 'sub_category.dart' as _i23;
import 'package:freshpickkat_client/src/protocol/app_user.dart' as _i24;
import 'package:freshpickkat_client/src/protocol/admin_audit_log_entry.dart'
    as _i25;
import 'package:freshpickkat_client/src/protocol/bogo_offer.dart' as _i26;
import 'package:freshpickkat_client/src/protocol/category.dart' as _i27;
import 'package:freshpickkat_client/src/protocol/coupon.dart' as _i28;
import 'package:freshpickkat_client/src/protocol/coupon_display.dart' as _i29;
import 'package:freshpickkat_client/src/protocol/order.dart' as _i30;
import 'package:freshpickkat_client/src/protocol/product.dart' as _i31;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i9.BogoOffer) {
      return _i9.BogoOffer.fromJson(data) as T;
    }
    if (t == _i10.CartItem) {
    ...
    if (t == _i12.Coupon) {
      return _i12.Coupon.fromJson(data) as T;
    }
    if (t == _i13.CouponDisplay) {
      return _i13.CouponDisplay.fromJson(data) as T;
    }
    if (t == _i14.CouponValidationResult) {
      return _i14.CouponValidationResult.fromJson(data) as T;
    }
    if (t == _i15.Order) {
    ...
    if (t == _i18.PaymentActionResult) {
      return _i18.PaymentActionResult.fromJson(data) as T;
    }
    if (t == _i19.PaymentOrderResult) {
      return _i19.PaymentOrderResult.fromJson(data) as T;
    }
    if (t == _i20.PaymentVerifyResult) {
      return _i20.PaymentVerifyResult.fromJson(data) as T;
    }
    if (t == _i21.Product) {
    ...
    if (t == _i23.SubCategory) {
      return _i23.SubCategory.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i9.BogoOffer?>()) {
      return (data != null ? _i9.BogoOffer.fromJson(data) : null) as T;
    }
    ...
    if (t == _i1.getType<_i12.Coupon?>()) {
      return (data != null ? _i12.Coupon.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i13.CouponDisplay?>()) {
      return (data != null ? _i13.CouponDisplay.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i14.CouponValidationResult?>()) {
      return (data != null ? _i14.CouponValidationResult.fromJson(data) : null)
          as T;
    }
    ...
    if (t == _i1.getType<_i18.PaymentActionResult?>()) {
      return (data != null ? _i18.PaymentActionResult.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i19.PaymentOrderResult?>()) {
      return (data != null ? _i19.PaymentOrderResult.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i20.PaymentVerifyResult?>()) {
      return (data != null ? _i20.PaymentVerifyResult.fromJson(data) : null)
          as T;
    }
    ...
    if (t == _i1.getType<_i23.SubCategory?>()) {
      return (data != null ? _i23.SubCategory.fromJson(data) : null) as T;
    }
    ...
    if (t == _i1.getType<List<_i10.CartItem>?>()) {
      return (data != null
              ? (data as List)
                    .map((e) => deserialize<_i10.CartItem>(e))
                    .toList()
              : null)
          as T;
    }
    ...
    if (t == List<_i25.AdminAuditLogEntry>) {
      return (data as List)
              .map((e) => deserialize<_i25.AdminAuditLogEntry>(e))
              .toList()
          as T;
    }
    ...
    if (t == List<_i28.Coupon>) {
      return (data as List).map((e) => deserialize<_i28.Coupon>(e)).toList()
          as T;
    }
    if (t == List<_i29.CouponDisplay>) {
      return (data as List)
              .map((e) => deserialize<_i29.CouponDisplay>(e))
              .toList()
          as T;
    }
    ...
    if (t == List<_i32.SubCategory>) {
      return (data as List)
              .map((e) => deserialize<_i32.SubCategory>(e))
              .toList()
          as T;
    }
    if (t == List<_i33.CartItem>) {
      return (data as List).map((e) => deserialize<_i33.CartItem>(e)).toList()
          as T;
    }
    try {
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      ...
      _i8.AppUser => 'AppUser',
      _i9.BogoOffer => 'BogoOffer',
      _i10.CartItem => 'CartItem',
      _i11.Category => 'Category',
      _i12.Coupon => 'Coupon',
      _i13.CouponDisplay => 'CouponDisplay',
      _i14.CouponValidationResult => 'CouponValidationResult',
      _i15.Order => 'Order',
      _i16.OrderItem => 'OrderItem',
      _i17.OrderPage => 'OrderPage',
      _i18.PaymentActionResult => 'PaymentActionResult',
      _i19.PaymentOrderResult => 'PaymentOrderResult',
      _i20.PaymentVerifyResult => 'PaymentVerifyResult',
      _i21.Product => 'Product',
      _i22.ProductPage => 'ProductPage',
      _i23.SubCategory => 'SubCategory',
      _ => null,
    };
  }
  ...
  String? getClassNameForObject(Object? data) {
    ...
    switch (data) {
      ...
      case _i12.Coupon():
        return 'Coupon';
      case _i13.CouponDisplay():
        return 'CouponDisplay';
      case _i14.CouponValidationResult():
      ...
      case _i17.OrderPage():
        return 'OrderPage';
      case _i18.PaymentActionResult():
        return 'PaymentActionResult';
      case _i19.PaymentOrderResult():
        return 'PaymentOrderResult';
      case _i20.PaymentVerifyResult():
        return 'PaymentVerifyResult';
      case _i21.Product():
        return 'Product';
      case _i22.ProductPage():
        return 'ProductPage';
      case _i23.SubCategory():
        return 'SubCategory';
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'BogoOffer') {
      return deserialize<_i9.BogoOffer>(data['data']);
    }
    ...
    if (dataClassName == 'Coupon') {
      return deserialize<_i12.Coupon>(data['data']);
    }
    if (dataClassName == 'CouponDisplay') {
      return deserialize<_i13.CouponDisplay>(data['data']);
    }
    if (dataClassName == 'CouponValidationResult') {
      return deserialize<_i14.CouponValidationResult>(data['data']);
    }
    ...
    if (dataClassName == 'PaymentActionResult') {
      return deserialize<_i18.PaymentActionResult>(data['data']);
    }
    if (dataClassName == 'PaymentOrderResult') {
      return deserialize<_i19.PaymentOrderResult>(data['data']);
    }
    if (dataClassName == 'PaymentVerifyResult') {
      return deserialize<_i20.PaymentVerifyResult>(data['data']);
    }
    ...
    if (dataClassName == 'SubCategory') {
      return deserialize<_i23.SubCategory>(data['data']);
    }
