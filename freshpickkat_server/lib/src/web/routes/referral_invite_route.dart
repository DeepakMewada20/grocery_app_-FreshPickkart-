...
class ReferralInviteRoute extends Route {
  ReferralInviteRoute() : super(methods: {Method.get});
  ...
  Future<Result> handleCall(Session session, Request request) async {
    ...
    return _landingPage(code);
  }

  Result _landingPage(String code) {
...
<head>
  ...
  <title>FreshPickKat — Referral Invite</title>
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .code-badge {
      display: inline-block; background: #eaf6ee; border: 1px solid #b9d8c3;
      border-radius: 10px; padding: 10px 24px; font-size: 18px; font-weight: 700;
      font-family: 'SF Mono', 'Cascadia Code', 'Menlo', monospace;
      color: #09622d; margin-bottom: 24px; letter-spacing: 1px;
    }
    .btn {
...
<body>
  <div class="card">
    ...
    <p>A friend wants to share the FreshPickKat experience with you.</p>
    ${code.isNotEmpty ? '<div class="code-badge">$code</div>' : ''}
