...
class AppUserUpdateTable extends _i1.UpdateTable<AppUserTable> {
  ...
  _i1.ColumnValue<List<_i2.CartItem>, List<_i2.CartItem>> cart(
    List<_i2.CartItem>? value,
  ) => _i1.ColumnValue(
    table.cart,
    value,
  );
...
class AppUserTable extends _i1.Table<int?> {
  AppUserTable({super.tableRelation}) : super(tableName: 'app_user') {
    ...
    cart = _i1.ColumnSerializable<List<_i2.CartItem>>(
      'cart',
      this,
    );
  }
  ...
  late final _i1.ColumnSerializable<List<_i2.CartItem>> cart;
