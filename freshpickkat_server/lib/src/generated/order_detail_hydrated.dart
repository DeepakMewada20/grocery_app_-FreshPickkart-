...
import 'refund_record.dart' as _i3;
import 'complaint.dart' as _i4;
import 'package:freshpickkat_server/src/generated/protocol.dart' as _i5;

abstract class OrderDetailHydrated
  ...
  Map<String, dynamic> toJsonForProtocol() {
    return {
      ...
      if (refund != null) 'refund': refund?.toJsonForProtocol(),
      if (activeProductComplaint != null)
        'activeProductComplaint': activeProductComplaint?.toJsonForProtocol(),
      if (activeDeliveryComplaint != null)
        'activeDeliveryComplaint': activeDeliveryComplaint?.toJsonForProtocol(),
    };
  }
