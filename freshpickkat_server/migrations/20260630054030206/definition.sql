...
CREATE TABLE "referral_settings" (
    ...
    "newAccountScore" bigint NOT NULL DEFAULT 20,
    "newAccountHours" bigint NOT NULL DEFAULT 48,
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('freshpickkat', '20260630054030206', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260630054030206', "timestamp" = now();
