...
CREATE TABLE "app_user" (
    ...
    "currentFreshPoints" bigint NOT NULL DEFAULT 0,
    "totalEarned" bigint NOT NULL DEFAULT 0,
    "totalRedeemed" bigint NOT NULL DEFAULT 0,
    "referralCode" text,
    "referralCodeApplied" text,
    "referralSource" text,
    "referralAppliedAt" timestamp without time zone,
    "referralWindowExpiresAt" timestamp without time zone,
    "referralOnboardingDismissedAt" timestamp without time zone,
    "termsAcceptedAt" timestamp without time zone,
    "codOrdersPlaced" bigint NOT NULL DEFAULT 0,
    "codOrdersDelivered" bigint NOT NULL DEFAULT 0,
    "codOrdersRejected" bigint NOT NULL DEFAULT 0,
    "isCodBlocked" boolean NOT NULL DEFAULT false,
    "codBlockedReason" text,
    "codBlockedAt" timestamp without time zone,
    "createdAt" timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
--
-- Class AutoRefundJobRow as table auto_refund_job
--
...
CREATE TABLE "banner" (
    ...
    "screenPlacements" text NOT NULL DEFAULT ''::text,
...
--
-- Class CodFailureRecord as table cod_failure_record
--
...
--
-- Class CodSettingsRow as table cod_settings
--
...
CREATE TABLE "coupon" (
    ...
    "couponCategory" text NOT NULL DEFAULT 'General'::text,
...
CREATE TABLE "customer_order" (
    ...
    "couponId" uuid,
    "paymentMode" text NOT NULL DEFAULT 'standard'::text,
    "paymentExpiresAt" timestamp without time zone,
    "paidByName" text,
    "paidByPhone" text,
    "paidByEmail" text,
    ...
    "paymentLinkId" uuid,
    "paymentLinkUrl" text,
    "paymentLinkExpiresAt" timestamp without time zone,
    "linkStatus" text,
    ...
    "categoryOfferDiscountAmount" double precision NOT NULL DEFAULT 0,
    ...
    "freshPointsUsed" bigint NOT NULL DEFAULT 0,
    "freshPointsValue" double precision NOT NULL DEFAULT 0,
    ...
    "codFailureReason" text,
    "deliveryPersonName" text,
    "deliveryPersonPhone" text,
    "deliveryOtp" text,
    "deliveryOtpExpiresAt" timestamp without time zone,
    "deliveryVerificationMethod" text DEFAULT 'otp'::text,
    "deliveryProofImageUrl" text,
    "deliveryProofLatitude" double precision,
    "deliveryProofLongitude" double precision,
    "deliveryProofTimestamp" timestamp without time zone,
    "deliveryProofDistanceMeters" double precision,
    "deliveryProofGpsAccuracy" double precision,
    "deliveredByUserId" text,
    "deliveredByName" text,
    "deliveredByRole" text DEFAULT 'admin'::text,
    "deliveryCompletedAt" timestamp without time zone,
    "deliveryOtpVerifiedAt" timestamp without time zone,
    "orderType" text NOT NULL DEFAULT 'regular'::text,
    "sourceOrderNumber" text,
    "complaintId" text,
    "paymentCollectedAt" timestamp without time zone,
    "paymentCollectedBy" text,
    "paymentCollectionMode" text,
...
--
-- Class DeliverySettingsRow as table delivery_settings
--
...
--
-- Class FreshPointsSettingsRow as table fresh_points_settings
--
CREATE TABLE "fresh_points_settings" (
    "id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
    "isEnabled" boolean NOT NULL DEFAULT true,
    "redemptionPercentageLimit" double precision NOT NULL DEFAULT 50.0,
...
--
-- Class FreshPointsTransactionRow as table fresh_points_transaction
--
...
CREATE TABLE "payment_link" (
    ...
    "linkType" text NOT NULL DEFAULT 'browser'::text,
    "linkStatus" text NOT NULL DEFAULT 'ACTIVE'::text,
    "generatedBy" text,
    "createdAt" timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
--
-- Class ReferralRow as table referral
--
CREATE TABLE "referral" (
    ...
    "fraudNotes" text,
    "fraudScore" bigint NOT NULL DEFAULT 0,
    "fraudBreakdown" text,
    "holdExpiresAt" timestamp without time zone,
    "scheduledReleaseAt" timestamp without time zone,
    "attempts" bigint NOT NULL DEFAULT 0,
    "lastError" text,
    "outstandingRecoveryPoints" bigint NOT NULL DEFAULT 0,
    "isRecoveryPending" boolean NOT NULL DEFAULT false,
    "recoveryReason" text,
    "dailyShareCount" bigint NOT NULL DEFAULT 0,
    "monthlyShareCount" bigint NOT NULL DEFAULT 0,
    "lastShareDate" timestamp without time zone,
    "createdAt" timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
--
-- Class ReferralSettingsRow as table referral_settings
--
CREATE TABLE "referral_settings" (
    ...
    "inviteeCouponMinOrderAmount" double precision NOT NULL DEFAULT 199.0,
    "inviteeCouponValidityDays" bigint NOT NULL DEFAULT 15,
    ...
    "lastUpdatedBy" uuid,
    "enableFraudScoring" boolean NOT NULL DEFAULT true,
    "autoApproveThreshold" bigint NOT NULL DEFAULT 40,
    "manualReviewThreshold" bigint NOT NULL DEFAULT 69,
    "autoRejectThreshold" bigint NOT NULL DEFAULT 90,
    "enableRewardHold" boolean NOT NULL DEFAULT true,
    "holdDurationHours" bigint NOT NULL DEFAULT 72,
    "enableAutoReject" boolean NOT NULL DEFAULT true,
    "minimumActualPaymentForQualification" double precision NOT NULL DEFAULT 0,
    "maxRewardedPerDay" bigint NOT NULL DEFAULT 3,
    "maxPendingReferrals" bigint NOT NULL DEFAULT 50,
    "maxSharesPerDay" bigint NOT NULL DEFAULT 100,
    "maxSharesPerMonth" bigint NOT NULL DEFAULT 1000,
    "referralVelocityScore" bigint NOT NULL DEFAULT 30,
    "velocityTimeWindowHours" bigint NOT NULL DEFAULT 24,
    "velocityThreshold" bigint NOT NULL DEFAULT 3,
    "autoReversalWindowDays" bigint NOT NULL DEFAULT 30,
    "termsText" text,
    "updatedAt" timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
--
-- Class ShopMoreGetMoreOfferRow as table shop_more_get_more_offer
--
...
--
-- Foreign relations for "auto_refund_job" table
--
...
--
-- Foreign relations for "cod_failure_record" table
--
...
--
-- Foreign relations for "fresh_points_transaction" table
--
...
--
-- Foreign relations for "referral" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('freshpickkat', '20260707084420676', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260707084420676', "timestamp" = now();
