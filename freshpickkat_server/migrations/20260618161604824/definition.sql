...
--
-- Prevent multiple ACTIVE payment links per order
CREATE UNIQUE INDEX IF NOT EXISTS "payment_link_active_order_idx"
    ON "payment_link" ("orderId")
    WHERE "isUsed" = false AND "linkStatus" = 'ACTIVE';
