...
class ReferralOnboardingSheet extends StatefulWidget {
  const ReferralOnboardingSheet({super.key});

  @override
  State<ReferralOnboardingSheet> createState() =>
      _ReferralOnboardingSheetState();
}

class _ReferralOnboardingSheetState extends State<ReferralOnboardingSheet> {
  ...
  Future<void> _validateCode() async {
    ...
    try {
      ...
      setState(() {
        _isValid = false;
        _validationMessage = 'Error validating code';
      });
    } finally {
  ...
  Future<void> _applyCode() async {
    ...
    try {
      ...
      setState(() {
        _validationMessage = 'Failed to apply code. Please try again.';
        _isApplying = false;
      });
    }
  }
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          OutlinedButton(
            onPressed: _isApplying ? null : _skip,
